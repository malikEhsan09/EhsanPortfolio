...
export const NavLink = styled.a`
  ...
  display: inline-block; /* Ensureing the width of the link adjusts to the text */
  text-decoration: none;
  ...
  /* Create the line under the NavLink using ::after */
  &::after {
    content: "";
    position: absolute;
    ...
    bottom: -4px; /* Distance between the text and the underline */
    left: 50%; /* Center the underline */
    transform: translateX(-50%); /* Adjust position to be centered */
    transition: width 0.4s ease-in-out, left 0.4s ease-in-out; /* Smooth transition */
  }

  /* On hover, expand the underline */
  &:hover::after {
    width: 100%; /* Expand to full width */
    left: 50%; /* Reset left to ensure it starts from the center */
    transform: translateX(-50%); /* Keep it centered */
  }

  /* Active state with underline always expanded */
  &.active::after {
